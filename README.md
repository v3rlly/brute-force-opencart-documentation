...
Nesse pequeno tutorial eu explico como realizar um ataque de força bruta baseado em lista de palavras em senhas armazenadas no banco de dados do OpenCart
